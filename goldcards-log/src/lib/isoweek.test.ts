...
const getISOWeekInfoTestCases: GetISOWeekInfoTestCase[] = [
	...
	{
		input: '2024-01-15T12:00:00.000Z', // Monday, week 3 of 2024
		expected: { week: 3, year: 2024 },
		purpose: 'calculate ISO week for Monday in January'
	},
	{
		input: '2024-01-10T15:30:00.000Z', // Wednesday, week 2 of 2024
		expected: { week: 2, year: 2024 },
		purpose: 'calculate ISO week for Wednesday in January'
	},
	{
		input: '2024-06-15T09:15:00.000Z', // Saturday, week 24 of 2024
	...
	{
		input: '2023-01-01T12:00:00.000Z', // Sunday, belongs to week 52 of 2022
		expected: { week: 52, year: 2022 },
		purpose: 'handle January 1st that belongs to last week of previous ISO year'
	},
	{
		input: '2022-01-01T15:30:00.000Z', // Saturday, belongs to week 52 of 2021
		expected: { week: 52, year: 2021 },
		purpose: 'handle January 1st that belongs to last week of previous ISO year'
	},
	{
		input: '2022-12-31T18:20:00.000Z', // Saturday, belongs to week 52 of 2022
		expected: { week: 52, year: 2022 },
		purpose: 'handle December 31st that belongs to last week of current ISO year'
	},
	{
		input: '2020-12-31T12:00:00.000Z', // Thursday, belongs to week 53 of 2020
	...
	{
		input: '2020-02-29T09:15:00.000Z', // Saturday, leap day in week 9 of 2020
		expected: { week: 9, year: 2020 },
		purpose: 'handle February 29th in leap year'
	},
	{
		input: '2024-02-29T14:30:00.000Z', // Thursday, leap day in week 9 of 2024
	...
	{
		input: '2024-01-08T12:00:00.000Z', // Monday, first Monday of 2024, week 2
		expected: { week: 2, year: 2024 },
		purpose: 'handle first Monday of January that is in week 2'
	},
	{
		input: '2023-01-02T09:15:00.000Z', // Monday, first Monday of 2023, week 1
	...
	{
		input: '2024-12-29T18:20:00.000Z', // Sunday, week 52 of 2024
		expected: { week: 52, year: 2024 },
		purpose: 'handle late December in week 52'
	},
	{
		input: '2024-12-31T22:45:00.000Z', // Tuesday, week 1 of 2025
